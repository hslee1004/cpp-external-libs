...
nmake /f Makefile.vc mode=static VC=%RUNTIME_VERSION% WITH_DEVEL=%DIR_OPENSSL%\debug WITH_SSL=static ENABLE_SSPI=no ENABLE_IDN=no ENABLE_WINSSL=no MACHINE=%MACHINE% DEBUG=yes GEN_PDB=yes
echo done.
